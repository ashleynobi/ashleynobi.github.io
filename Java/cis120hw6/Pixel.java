...
public class Pixel implements Comparable<Pixel> {
    ...
    int redDist = Math.abs(px.r - r);
    int blueDist = Math.abs(px.b - b);
    int greenDist = Math.abs(px.g - g);
  
        return redDist + blueDist + greenDist; // TODO: Implement this
    }
    ...
    String stringPixel = "(" + r + ", " + g + ", " + b + ")";
        return stringPixel; // TODO: Implement this
    }
    ...
    public boolean equals(Pixel px) {
        return ((px.r == r) && (px.g == g) && (px.b == b)); // TODO: Implement this
    }
